void steps_direction() //This funtion determiens the number of steps and direction the motors must rotate
{                      // it is given the current angle and desired angle of the stepper motors and the function
                      //  sets the direction for the motor to rotate
