void routine() // This fucntion excecutes the varius routiens
{
  ...
  { 
    ...
    if(launch1 == HIGH && launch2 == LOW) // throw motor 1 motor 2 remians stationary
    {
      ...
      OCR4A = 3000;
      desiredAngle1 = launchAngle1;
      desiredAngle2 = currentAngle2;//launchAngle2 + angleOffset2;
      decelSteps1 = decelSteps;//25
      decelSteps2 = decelSteps; //Casues the motor to move up slightly to catch the ball
      accel1 = HIGH;
      accel2 = LOW;
      ...
      desiredAngle2 = launchAngle1-1.8;
      decelSteps1 = 0;
      decelSteps2 = 0;
      OCR3A = 1800;
      OCR4A = 1800;
    ...
    if(launch2 == HIGH && launch1 == LOW) // launch motor 2 motor 1 remains stationary
    {
      ...
      OCR4A = 3000;
      desiredAngle1 = currentAngle1;//launchAngle1 + angleOffset1;
      desiredAngle2 = launchAngle2;
      decelSteps1 = decelSteps;
      decelSteps2 = decelSteps;
      accel1 = LOW;
      accel2 = HIGH;
      tic = micros();
      ...
      desiredAngle1 = launchAngle2- 1.8;
  ...
  {   
    ...
    desiredAngle1 = launchAngle1; //81.45
    desiredAngle2 = launchAngle2;
    decelSteps1 = decelSteps;
    decelSteps2 = decelSteps;
    accel1 = HIGH;
    ...
    desiredAngle1 = launchAngle2-5.4; //81.45
    desiredAngle2 = launchAngle1-0.9;
    decelSteps1 = 0;
    decelSteps2 = 0;
    OCR3A = 1800;
    OCR4A = 1800;
  ...
  {   
    ...
    desiredAngle1 = launchAngle1; //81.45
    desiredAngle2 = launchAngle2;
    decelSteps1 = decelSteps;//30
    decelSteps2 = decelSteps;//30
    accel1 = HIGH;
    accel2 = HIGH;
    tic = micros();
    ...
    desiredAngle1 = launchAngle1 - 0.9; //81.45
    desiredAngle2 = launchAngle2 - 0.9;
    decelSteps1 = 0;
    decelSteps2 = 0;
    OCR3A = 2000;
    OCR4A = 2000;
  ...
  if(jugglerConfigSubMode5 == 4 && enableState == HIGH) // One ball vertical mode right (motor 2)
  {   
    enableState = LOW;
    zero1 = HIGH;
    zero2 = HIGH;
  ...
  if(jugglerConfigSubMode5 == 5 && enableState == HIGH) // One ball vertical mode left (motor 1)
  {   
    enableState = LOW;
    zero1 = HIGH;
    zero2 = HIGH;
