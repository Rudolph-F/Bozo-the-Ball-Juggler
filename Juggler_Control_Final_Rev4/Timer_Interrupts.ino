ISR(TIMER3_COMPA_vect) // Compare registor vector that generatats step pulses for motor 1
{
...
ISR(TIMER4_COMPA_vect) // Compare registor vector that generatats step pulses for motor 2
{
